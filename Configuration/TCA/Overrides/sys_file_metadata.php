...
(function () {
    $tempColumns = [
        ...
        'hd_description' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hd_structureddata/Resources/Private/Language/locallang_be.xlf:sys_file_metadata.hd_description',
            'config' => [
                'type' => 'text',
                'eval' => 'trim'
            ]
    ...
    --linebreak--, hd_caption, --linebreak--, hd_keywords, --linebreak--, hd_description, --linebreak--,
